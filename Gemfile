...
group :preload do
  ...
  # AR extensions
  gem 'goldiloader', git: "https://github.com/grosser/goldiloader", branch: "grosser/bump" # https://github.com/salsify/goldiloader/pull/45
  gem 'kaminari'
...
gem 'github-markdown'
gem 'coderay'
gem 'net-http-persistent', '~> 2.9.4' # v3 breaks zendesk_notification_test.rb
gem 'concurrent-ruby'
gem 'vault'
gem 'docker-api'
gem 'newrelic_rpm'
