...
module.exports = function(config) {
  config.set({
    ...
    files: [
      '<%= resolve_javascript("jquery/jquery.js") %>',
      '<%= resolve_javascript("angular/angular.js") %>',
      ...
      '<%= resolve_javascript("angular-spinner/angular-spinner.js") %>',
      '<%= resolve_javascript("angular-ui-router/angular-ui-router.js") %>',
      '<%= resolve_javascript("angular-truncate-2/angular-truncate-2.js") %>',
