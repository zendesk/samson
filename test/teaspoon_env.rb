Teaspoon.configure do |config|
  ...
  config.asset_paths = ["test/angular"]
  Dir['plugins/*'].each { |d| config.asset_paths << "#{d}/test/angular"; config.asset_paths << "#{d}/app/assets/javascripts" }
  ...
  config.suite do |suite|
    ...
    suite.matcher = "{test/angular,app/assets,plugins}/**/*_spec.{js,js.coffee,coffee}"
