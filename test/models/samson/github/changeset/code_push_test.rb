...
describe Samson::Github::Changeset::CodePush do
  let(:data) do
    {
  ...
  let(:push) { Samson::Github::Changeset::CodePush.new('foo/bar', data) }
  ...
  describe ".valid_webhook?" do
    it "is true" do
      Samson::Github::Changeset::CodePush.valid_webhook?(1).must_equal true
    end
  end

  describe ".Samson::Github::Changeset_from_webhook" do
    it "passes data on" do
      push = Samson::Github::Changeset::CodePush.changeset_from_webhook(projects(:test), data)
