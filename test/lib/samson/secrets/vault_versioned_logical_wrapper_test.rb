...
describe Samson::Secrets::VaultVersionedLogicalWrapper do
  ...
  describe '#list' do
    it 'lists keys' do
      ...
      server.client.logical.list.must_equal ['foo']
    end
  end
  ...
  describe '#read' do
    it 'reads secrets' do
      ...
      result = server.client.logical.read('foo/bar')
  ...
  describe '#write' do
    it 'writes secrets' do
      ...
      result = server.client.logical.write('super_secret', cool: 'beans')
  ...
  describe '#delete' do
    it 'deletes secrets' do
      ...
      server.client.logical.delete('foo/my_secret')
    end
  end
  ...
  describe '#list_recursive' do
    it 'iterates through all keys' do
      ...
      server.client.logical.list_recursive.must_equal ['abc/ghi', 'def']
    end
  end
end
