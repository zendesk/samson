...
describe('Buddy requests notifications', function () {
  ...
  describe('BuddyNotificationCtrl', function() {
    var buddyNotificationsCtrl, scope, flowdock, rootScope, element;
    ...
    beforeEach(inject(function ($controller) {
      scope = rootScope.$new();
      scope.deploy = 1;
      buddyNotificationsCtrl = $controller('BuddyNotificationsCtrl', { $scope: scope, $rootScope: rootScope, Flowdock: flowdock });
    }));
