...
describe SamsonDatadog do
  ...
  describe :repo_compare do
    ...
    it "catches exception and returns NullComparison" do
      stub_github_api("repos/foo/bar/compare/a...b", {}, 301, {'location': 'https://api.github.com/repos/foobar/bar/compare'})
      assert_raises(Octokit::Middleware::RedirectLimitReached) { fire("a", "b") }.message.must_include "too many redirects; last one to: https://api.github"
    end
  end
end
