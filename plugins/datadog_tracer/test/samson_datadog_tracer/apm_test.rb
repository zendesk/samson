  ...
  describe ".trace_method_execution_scope" do
    ...
    it "skips tracer when disabled" do
      with_env DATADOG_TRACER: nil do
        ...
        SamsonDatadogTracer::APM.trace_execution_scoped("test") { "without tracer" }
      end
    end
    ...
    it "trigger tracer when enabled" do
      ...
      SamsonDatadogTracer::APM.trace_execution_scoped("test") { "with tracer" }
    end
  end
  ...
  describe ".trace_method" do
    let(:instance) do
      Class.new do
        ...
        SamsonDatadogTracer::APM.trace_method self, :pub_method
        SamsonDatadogTracer::APM.trace_method self, :pri_method
        SamsonDatadogTracer::APM.trace_method self, :pro_method
      end.new
    end
    ...
    it "fails with undefined method" do
      e = assert_raise NameError do
        SamsonDatadogTracer::APM.trace_method instance.class, :no_method
      end
