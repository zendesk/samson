...
describe JobRubyScript do
  ...
  subject { Samson::JobRubyScript.new(job, 'master', 'cache/dir', 'working/dir', StringIO.new) }

  describe '#commands' do
    it 'creates the appropriate script' do
      subject.commands.must_equal ["ENV['DEPLOYER']      = '#{ob.user.email.shellescape}'",
  ...
  describe '.display_name!' do
    it 'has set the appropriate name for UI' do
      Samson::JobRubyScript.display_name.must_equal 'Ruby Script'
    end
  end
end
