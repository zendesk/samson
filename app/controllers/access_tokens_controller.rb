...
class AccessTokensController < ApplicationController
  ...
  def create
    ...
    Samson::Hooks.fire(:controller_action, current_user, 'created access token', token.id)
    redirect_to(
      {action: :index},
  ...
  def destroy
    ...
    Samson::Hooks.fire(:controller_action, current_user, 'deleted access token', params.require(:id))
    redirect_to(
      {action: :index},
